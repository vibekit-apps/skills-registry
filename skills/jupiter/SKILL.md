...
**Free tier**: `https://lite-api.jup.ag` — free, no API key required. Supports Ultra Swap, Price v3, and basic endpoints. Use this for simple swaps and price checks.
**Auth**: `x-api-key` from [portal.jup.ag](https://portal.jup.ag/) (**required for `api.jup.ag` endpoints**, not needed for `lite-api.jup.ag`)
